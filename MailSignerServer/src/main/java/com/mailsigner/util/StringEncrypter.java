...
public class StringEncrypter {
	...
	public static class EncryptionException extends Exception {
		 ...
		 * 
		 */
		private static final long serialVersionUID = -3066590329981363117L;
	...
	public String encryptWrapper(String string){
		String encryptedLogin = "";
		try {
			encryptedLogin = encrypt(string);	
	...
	public String decryptWrapper(String encryptedString){
		String string = "";
		try {
