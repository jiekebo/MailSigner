...
public class HSQLDBTest {
	public static void main(String[] args) {
		...
		serverThread.start();
		// hsqlThread.requestStop();
		// Thread clientThread = new Thread(new HSQLDBRequestThread());
		// clientThread.start();

		EntityManagerFactory emf = Persistence.createEntityManagerFactory("MailSignerJPA");
